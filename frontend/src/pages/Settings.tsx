...
import { User, Lock, Shield, Eye, EyeOff, UserPlus } from 'lucide-react';
...
export default function Settings() {
  ...
  const handleCreateUser = async (e: React.FormEvent) => {
    ...
    try {
      await authApi.createUser({ email: newUserEmail, password: newUserPassword, name: newUserName || undefined, role: newUserRole });
          ...
          <div className="bg-white rounded-xl border border-gray-200">
            <div className="flex items-center gap-3 p-5 border-b border-gray-100">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500">Solo los administradores pueden crear nuevas cuentas</p>
              </div>
            </div>
            <form onSubmit={handleCreateUser} className="p-5 space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-sm font-semibold text-gray-700 mb-2">Rol <span className="text-red-500">*</span></label>
                  <select
                    value={newUserRole}
              ...
              <div>
                <label className="block text-sm font-semibold text-gray-700 mb-2">Contraseña inicial <span className="text-red-500">*</span></label>
                <div className="relative">
                  <input
                    ...
                    className="w-full px-4 py-2.5 pr-10 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-orange-500 focus:border-transparent transition"
                  />
                  <button type="button" onClick={() => setShowNewUserPassword(v => !v)}
                    className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-gray-600">
